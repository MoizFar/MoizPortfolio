      ...
      <div className="projects-container"></div>
                        ...
                        <div class="project-card project-card-light">
                                    ...
                                    <div class="project-detail">
                                        ...
                                        <h5 class="card-title">ATCS – Aviation Tool Compliance System</h5>
                                        ...
                                        <p>
                                          Engineered a high-compliance system for issuing, tracking, and managing aviation tools, PME/PMI, and
                                          calibrated equipment.
                                          Integrated biometric and barcode-based authentication for secure tool access and traceability.
                                          Built dedicated PME/PMI modules for lifecycle tracking, calibration scheduling, and audit logging to ensure
                                          operational readiness.
                                          Enabled real-time inventory control, calibration alerts, and tool status monitoring in line with aviation
                                          safety standards.
                                          Designed tool kit verification with sub-tool visibility and colour-coded issuance/return checks.
                                          Implemented role-based access control with full audit trails and a dashboard for actionable insights.
                                          Enforced tool accountability via a day-end store closure mechanism, preventing shutdown until all tools are
                                          returned.
                                          Delivered a scalable, audit-ready platform with advanced store configuration and future-ready multi-site
                                          support.
                                        </p>
                        ...
                        <div class="project-card project-card-light">
                                    ...
                                    <div class="project-detail">
                                        ...
                                        <h5 class="card-title">HRMS - Human Resource Management System</h5>
